okex
====
[![Go Reference](https://pkg.go.dev/badge/github.com/limebear/okex.svg)](https://pkg.go.dev/github.com/limebear/okex)
[![GitHub go.mod Go version of a Go module](https://img.shields.io/github/go-mod/go-version/limebear/okex.svg)](https://github.com/limebear/okex)
[![GoReportCard example](https://goreportcard.com/badge/github.com/limebear/okex)](https://goreportcard.com/report/github.com/limebear/okex)
[![GitHub license](https://img.shields.io/github/license/limebear/okex.svg)](https://github.com/limebear/okex/blob/main/LICENSE)
[![GitHub release](https://img.shields.io/github/release/limebear/okex.svg)](https://GitHub.com/limebear/okex/releases/)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)
[![CI](https://github.com/limebear/okex/actions/workflows/main.yml/badge.svg)](https://github.com/limebear/okex/actions/workflows/main.yml)
[![CodeQL](https://github.com/limebear/okex/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/limebear/okex/actions/workflows/codeql-analysis.yml)
[![AutoRelease](https://github.com/limebear/okex/actions/workflows/release.yml/badge.svg)](https://github.com/limebear/okex/actions/workflows/release.yml)
...
```bash
go get github.com/limebear/okex@v1.1.4-alpha
```
...
import (
  ...
  "github.com/limebear/okex/api"
  "github.com/limebear/okex/events"
  "github.com/limebear/okex/events/public"
  ws_public_requests "github.com/limebear/okex/requests/ws/public"
  "log"
)
...
* To receive websocket events you can choose [RawEventChan](/api/ws/client.go#L25)
  ...
  channels. [More info](https://github.com/limebear/okex/wiki/Handling-WS-events) 
